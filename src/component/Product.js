                                ...
                                return (
                                    <div key={e.id} className="flex flex-col items-center justify-center w-full max-w-[300px] mx-auto">
                                        ...
                                        <div className='flex justify-between w-full'>
                                            <button className="flex items-center justify-center  px-2 py-2 mt-4 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-gray-800 rounded-md hover:bg-gray-700 focus:outline-none focus:bg-gray-700">
                                            ...
                                            <div className='flex h-full gap-2 items-end pb-2'>
                                                ...
                                                <input type="number" className='w-[60px] rounded-md text-center text-sm py-1 px-2 text-white capitalize transition-colors duration-200 transform bg-gray-800 hover:bg-gray-700 focus:outline-none focus:bg-gray-700'></input>
                                            </div>
                                        </div>
                                    </div>
                                )
